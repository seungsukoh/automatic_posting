...
Instagram은 개인계정을 Creator 계정으로 전환하는 방향으로 진행한다.

이 프로젝트는 로그인 세션 자동조작이 아니라 공식 OAuth/API 기반 자동 포스팅 도구로 구현한다.

## 2. Instagram Creator 준비

필수 확인:

- Instagram 개인계정을 Creator 계정으로 전환할 수 있다.
- Facebook Page를 생성하거나 기존 Page를 연결할 수 있다.
- Instagram Creator 계정과 Facebook Page를 Meta 계정 센터 또는 Meta Business Suite에서 연결할 수 있다.
...
1. Instagram Creator 전환과 Facebook Page 연결을 완료한다.
